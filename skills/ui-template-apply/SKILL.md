...
- 项目根必须有 digest 一致的 `design-system/v1` Active Instance；schema v2 template 与旧 freeze 都是 migration-only source。increment 缺 Active Instance 停止。bootstrap 可按 [active-implementation.md](references/active-implementation.md) adopt-only。
