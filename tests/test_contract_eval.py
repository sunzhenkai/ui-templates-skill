...
class ContractEvalTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        files = [
            ...
            "tests/fixtures/eval/apply-design-decision-contracts.yaml",
    ...
    def test_case_and_result_schemas_cover_all_current_cases(self) -> None:
        ...
        expected_ids = {
            ...
            "apply-original-alignment-handoff", "apply-source-blind-rejection",
            "apply-pattern-bound-composition", "apply-missing-reusable-control-feedback",
        ...
        self.assertEqual({"script": 58, "llm": 2}, judges)
        self.assertEqual(
            {
                "skills/ui-template-author/evals/cases.yaml",
                "skills/ui-template-apply/evals/cases.yaml",
    ...
    def test_happy_path_is_stable_and_matches_locked_baseline(self) -> None:
        ...
        self.assertEqual({"declared": 60, "parsed": 60, "executed": 60, "script": 58, "llm": 2}, first["counts"])
